...
"  --n-loci N               randomly sample N windows from the survivors\n"
"                           (omit to keep every surviving window)\n"
...
"  -h, --help               this message\n"
"\n"
"Output: a 4-column BED (chrom, 0-based start, exclusive end, locus name)\n"
"ready to pass to the conversion flow alongside BAM/CRAM or gVCF inputs.\n"
"\n"
